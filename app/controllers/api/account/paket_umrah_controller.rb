class Api::Account::PaketUmrahController < ApplicationController
	...
	def self.renderingDetail(api_url, kode, kd_kantor, session, x_bulan, x_tahun)
		begin
		res = RestClient.get api_url + '/produk/umrah/' + kode, {
	...
	def invoicePaket
		begin
			...
			if mobile_device?
				render "mobile/transaction/invoice/index", layout: "application_mobile", locals: {data: @data}
			else
