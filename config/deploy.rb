...
server '13.228.204.120', port: 22, roles: [:web, :app], primary: true

set :application, "abutoursweb"
set :repo_url, "git@github.com:Caryta/beta.abutours.com.git"
set :user, "devops"
