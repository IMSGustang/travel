...
(function ($) {
    ...
    $.fn.dsCountDown = function (givenOptions) {
        ...
        var defaults = {
            ...
            titleDays: 'hari',			// Set the title of days
            titleHours: 'jam',		// Set the title of hours
            titleMinutes: 'menit',	// Set the title of minutes
            titleSeconds: 'detik',	// Set the title of seconds
